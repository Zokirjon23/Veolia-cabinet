...
kotlin {
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation(libs.insert.koin.koin.viewmodel)
...
android {
    ...
    defaultConfig {
        applicationId = "uz.veolia.cabinet"
...
compose.desktop {
    application {
        mainClass = "uz.veolia.cabinet.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "uz.veolia.cabinet"
